                ...
                <div class="row">
                    <div class="col-md-4 footer-box">
                        ...
                        <div class="footer-sub footer-menu">
                            <ul>
                                <li class="menu-item ">
                                    <a href="<?= Url::to('/site/huong-dan-thanh-toan')?>" rel="follow">Hướng dẫn thanh toán</a>
                                </li>
                                <li class="menu-item ">
                                    <a href="<?= Url::to('/site/chinh-sach-giao-hang')?>" rel="follow">Chinh sách giao hàng</a>
                                </li>
                                <li class="menu-item ">
                                    <a href="<?= Url::to('/site/chinh-sach-doi-tra')?>" rel="follow">Chính sách đổi trả</a>
                                </li>
                                <li class="menu-item ">
                                    <a href="<?= Url::to('/site/chinh-sach-bao-hanh')?>" rel="follow">Chính sách bảo hành</a>
                                </li>
                                <li class="menu-item ">
                                    <a href="<?= Url::to('/site/chinh-sach-bao-mat-thong-tin')?>" rel="follow">Chính sách bảo mật thông
                                    tin</a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="col-md-4 footer-box">
                        <p class="footer-title">Điện máy Thành Lợi</p>
                        <div class="footer-sub footer-menu">
                            <ul>
                                <li class="menu-item ">
                                    <a href="<?= Url::to('/site/he-thong-showroom')?>" rel="follow">Hệ thống Showroom</a>
                                </li>
                                <li class="menu-item ">
                        ...
                        <div class="footer-sub footer-menu">
                            <ul>
                                ...
                                if(!empty($cats)){
                                    foreach ($cats as $cat){ ?>
                                        <li class="menu-item ">
                                            <a href="<?= \yii\helpers\Url::to(['products/list-products-cat','slug'=>$cat->slug])?>" rel="follow"><?= ucwords($cat->name)?></a>
                                        </li>
                                    <?php }
                                }
                                ?>
                    ...
                    <div class="col-md-8 footer-box">
                        <p class="footer-title footer-small-title">Công ty TNHH điện máy Thành Lợi</p>
                        <div class="footer-sub footer-info zing-content">
                            ...
                            <p>Chủ tài khoản:&nbsp;Công Ty TNHH Điện Máy Thành Lợi</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="footer-top-right">
                <div class="footer-box">
                    ...
                    <div class="footer-sub social">
                        <a class="social-facebook" href="https://www.facebook.com/dienmaythanhloi.vn/"
                        target="_blank" title="Facebook" rel="nofollow"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                        <a class="social-google" href="" target="_blank" title="Google+" rel="nofollow"><i class="fa fa-google-plus" aria-hidden="true"></i>
                        </a>
                            <a class="social-twitter" href="" target="_blank" title="Twitter" rel="nofollow"><i class="fa fa-twitter" aria-hidden="true"></i>
                            </a>
                            </div>
                        </div>
