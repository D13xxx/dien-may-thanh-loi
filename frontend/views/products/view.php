...
<div class="breadcrumb-box">
    <div class="container">
        <ul class="breadcrumb" itemscope="" itemtype="http://schema.org/BreadcrumbList">
            <li><a href="https://dienmaythanhloi.vn/"><span>Trang chủ</span></a></li>
            ...
            <li itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem">
                <a itemtype="https://schema.org/Thing" itemprop="item" href="https://dienmaythanhloi.vn/may-duc-be-tong-amax-am-0810"><span itemprop="name"><?= ucwords($model->full_name)?></span></a>
            ...
            <div class="product-right">
                ...
                <div class="product-hotline">
                    <div class="product-hotline-item">
                        ...
                        <p class="product-hotline-list">0985.65.880&nbsp;|&nbsp;&nbsp;0912.543.455</p>
                    </div>
                    <div class="product-hotline-item">
                        <p class="product-info-title">Kỹ thuật</p>
                        <p class="product-ky-thuat-list">0985.65.880&nbsp;|&nbsp;&nbsp;0912.543.455</p>
                    </div>
                </div>
