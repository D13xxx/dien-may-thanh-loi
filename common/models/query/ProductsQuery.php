...
class ProductsQuery extends Products
{
    ...
    {
        return [
            [['id', 'created_at', 'updated_at', 'status', 'code', 'guarantce', 'sale_number', 'is_new', 'is_hot_new', 'cat_id', 'type', 'brand', 'views'], 'integer'],
            [['full_name', 'description', 'slug', 'content', 'avatar'], 'safe'],
