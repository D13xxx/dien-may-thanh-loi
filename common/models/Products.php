...
class Products extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['full_name', 'price', 'description', 'slug', 'content', 'created_at', 'status', 'code', 'guarantce', 'exp_price', 'sale_number', 'is_new', 'is_hot_new', 'cat_id', 'type','avatar', 'brand'], 'required'],
            ...
            [['full_name', 'description', 'slug'], 'string', 'max' => 255],
            [['avatar'], 'safe'],
