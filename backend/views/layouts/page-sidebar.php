...
<div class="page-sidebar">
    ...
    <ul class="x-navigation">
        ...
        <?php } ?>
        <li class="xn-openable">
            <a href="#"><span class="fa fa-cogs"></span> <span class="xn-text">M04 - Sản phẩm</span></a>
            <ul>
        ...
        <li class="xn-openable">
            <a href="#"><span class="fa fa-cogs"></span> <span class="xn-text">M05 - Đơn hàng</span></a>
            <ul>
                <li><a href="<?= Url::to('/order-products/index')?>"> Danh sách đơn hàng</a></li>
            </ul>
        </li>
        <li class="xn-openable">
            <a href="#"><span class="fa fa-cogs"></span> <span class="xn-text">M07 - Đối tác</span></a>
            <ul>
